  ...
  )
{
  ...
  while ((Link != &RequestBlockArray->Entry) && (Link->ForwardLink != &RequestBlockArray->Entry)) {
    ...
    if ((NextBlockData->Offset >= BlockData->Offset) && (NextBlockData->Offset <= (UINT32)BlockData->Offset + BlockData->Width)) {
      if ((UINT32)NextBlockData->Offset + NextBlockData->Width > (UINT32)BlockData->Offset + BlockData->Width) {
        BlockData->Width = (UINT16)((UINT32)NextBlockData->Offset + NextBlockData->Width - BlockData->Offset);
      }
